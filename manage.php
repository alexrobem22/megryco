            ...
            <div class="desing-tamanho">
                <div class="part1">
                    ...
                    <div class="part1-items">
                        ...
                        <div class="parte1-p">
                            <p>Simply put, our property management services reflect the communities we strive to build: Dependable, communicative and personal.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="parte2-conteudo">
                    ...
                    <div class="parte2-divs">
                        ...
                        <div class="parte2-div2">
                            <h1>Reliable service in a <br> fluctuating market.</h1>
                        </div>
                        <div class="parte2-div3">
                            <p>Finding a home is a personal experience, which is why we always work to accommodate your individual needs. With our small team of decision makers, you bypass the big leasing company scripts, complex corporate jargon and inflexibility for your personal circumstances—while still having access to an array of living options.<br><br>

                                We believe in building our neighborhoods beyond physical structures, which is why we strive to connect our clients to thriving communities, not just place them in a building. </p>
                        </div>
